...
const About = () => {
    ...
    return (
        <div>
            ...
            <div className="container mx-auto pb-8">
                <H4 style="font-bold text-primary pb-4" text="Why study Software Engineering?"/>
                <P style="text-neutral" text="It is hard to overstate the ubiquity of software nowadays. Every computer system is 
            ...
            <div className="container mx-auto pb-8">
                <H4 style="font-bold text-primary pb-4" text="Careers in Software Engineering"/>
                <P style="text-neutral" text="There are abundant career opportunities for graduates from the software engineering program."/>
                <P style="text-neutral" text="For example, they are software engineers, software architects, software developers on various 
                ...
                <P style="text-neutral" text="Nevertheless, with strong foundation in computer science, mathematics, 
