  ...
  return (
    <>
      ...
      <section className="mb-8">
        <H4 style="text-primary font-bold mb-4" text="Application Guidance" />
        <ul className="list-decimal ml-5 text-sm sm:text-base md:text-lg lg:text-xl">
          ...
          <li>
            ...
            You are to do the <b>course registration</b> when you are in the UK.
            Your advisor at UoG will help you with the course registration when
            you arrive at UoG.
          </li>
          <li>
          ...
          <li>
            ...
            <b>SE program director</b>, Asst.Prof.Dr. Visit Hirankitti
