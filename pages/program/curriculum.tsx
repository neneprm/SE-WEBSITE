...
const Curriculum = () => {
    return (
        <div>
            ...
            <section>
                <H4 style="text-primary font-bold" text="B.Eng. in Software Engineering Program" />
