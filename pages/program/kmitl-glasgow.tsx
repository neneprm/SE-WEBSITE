      ...
      <section>
        ...
        <div>
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl">
            * Rates as of Academic Year 2022. Every student joining the
            ...
            reduction from the full tuition-fee rate for international students
        ...
        <div>
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl">
            ...
            Year 2 of their study in the SE program. Second-year SE students who
            meet the requirements above and wish to apply need to inform the SE
            program director before the end of Year 2 Semester 2 and submit
            their applications on the UCAS system <b>no later than 30 June</b>{" "}
