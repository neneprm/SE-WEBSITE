    ...
    <div>
      ...
      <section>
        <div>
          ...
          <div className="overflow-x-auto">
            <table className="table table-compact w-auto m-auto px-10">
              <thead>
                <tr>
                  <th className="bg-[#DF6F3A]">
                    <P style="text-base-100 text-center" text="Expense" />
                  </th>
                  <th className="bg-[#DF6F3A]">
                    <P style="text-base-100 text-center" text="Cost*" />
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>
                    <P text="Round-trip flight ticket" />
                  </td>
                  <td>
                    <P style="text-center" text="47,000 THB" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <P text="Semester ticket (covering public transport)" />
                  </td>
                  <td>
                    <P style="text-center" text="330 €" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <P text="Health insurance (80 € / month)" />
                  </td>
                  <td>
                    <P style="text-center" text="400 €" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <P text="Accommodation (280 – 380 € / month)" />
                  </td>
                  <td>
                    <P style="text-center" text="1,900 €" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <P text="Food (200 - 400 € / month)" />
                  </td>
                  <td>
                    <P style="text-center" text="2,000 €" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <P text="Communication - Internet, cell phone (40 € / month)" />
                  </td>
                  <td>
                    <P style="text-center" text="200 €" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <P style="font-bold" text="Total per semester (5 months)" />
                  </td>
                  <td>
                    <P style="text-center font-bold" text="≈ 250,000 Baht" />
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <P
            style="text-center"
            text="*Cost : Estimated cost / semester (5 months)*"
          />
          <br />
        </div>
      </section>
          ...
          <div className="overflow-x-auto">
            <table className="table w-auto m-auto px-10">
              <thead>
                <tr>
                  <th className="bg-[#DF6F3A]">
                    <P style="text-base-100 text-center" text="Activity" />
                  </th>
                  <th className="bg-[#DF6F3A]">
                    <P style="text-base-100 text-center" text="Date" />
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>
                    <P style="font-bold" text="Submit an intent to apply" />
                  </td>
                  <td>
                    <P style="text-center font-bold" text="TBA" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <P
                      style="font-bold"
                      text="Application deadline on FRA-UAS webseite (strict)"
                    />
                  </td>
                  <td>
                    <P style="text-center font-bold" text="TBA" />
                ...
                <tr>
                  <td>
                    <P text="Arrival at Frankfurt" />
                  </td>
                  <td>
                    <P style="text-center" text="TBA" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <P text="Orientation activities" />
                  </td>
                  <td>
                    <P style="text-center" text="TBA" />
                  </td>
                ...
                <tr>
                  <td>
                    <P text="Start of Academic Year 2019 at KMITL" />
                  </td>
                  <td>
                    <P style="text-center" text="TBA" />
                  </td>
