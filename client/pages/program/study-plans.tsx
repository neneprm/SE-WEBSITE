            ...
            <section className="mb-8">
                ...
                <div className="flex">
                    <div className="flex-auto">
                        ...
                        <div className="flex">
                            <label className="label cursor-pointer ">
                                <input type="radio" name="university" className="radio checked:bg-primary mr-2" />
                    ...
                    <div className="flex-auto">
                        ...
                        <div className="flex">
                            <label className="label cursor-pointer ">
                                <input type="radio" name="specializations" className="radio checked:bg-primary mr-2" />
                    ...
                    <div className="flex-auto">
                        ...
                        <div className="flex">
                            <label className="label cursor-pointer ">
                                <input type="radio" name="year" className="radio checked:bg-primary mr-2" />
                    ...
                    <div className="flex-auto">
                        ...
                        <div className="flex">
                            <label className="label cursor-pointer ">
                                <input type="radio" name="radio-10" className="radio checked:bg-primary mr-2" />
                    ...
                    <div className="flex-auto">
                        ...
                        <div className="flex">
                            <label className="label cursor-pointer ">
                                <input type="radio" name="elective" className="radio checked:bg-primary mr-2" />
                    ...
                    <div className="flex-auto">
                        <H4
                            ...
                            text="Search"
                        />
                        <input type="text" placeholder="Type here" className="input input-bordered input-primary rounded-full w-full max-w-xs mt-2 mb-5" />
