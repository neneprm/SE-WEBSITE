...
const StudyPlans2 = () => {
  ...
  return (
    <>
      ...
      {/* <section className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
        <input type="checkbox" className="peer" />
        <div className="collapse-title flex justify-end">
          <BsFillFilterCircleFill className="text-accent text-2xl" />
        </div>
